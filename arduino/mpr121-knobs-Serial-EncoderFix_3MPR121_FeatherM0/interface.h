...
const int enc1PinA = 5;// 5; //9; // Our first hardware interrupt pin is digital pin 2
const int enc1PinB = 6; //6; //10; // Our second hardware interrupt pin is digital pin 3
const int enc1ButtPin = 9;//9; //11; // Our first hardware interrupt pin is digital pin 2
const int enc1_ID = 0;
...
const int irqpin = 0;  // Digital 2
const int irqpin2 = 1; 
int octave = 3;
boolean touchStates[12]; //to keep track of the previous touch states
boolean touch2States[4];
boolean quadStates[8];  //change here
boolean touchOut[16];  //change here
